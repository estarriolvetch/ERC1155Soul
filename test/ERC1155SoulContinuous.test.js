...
describe.only("ERC1155SoulContinuous", function () {
  ...
  it("ERC1155SoulContinuous", async function () {
    ...
    const batchOffSet = accounts.length;
  ...
  it("ERC1155SoulContinuous with non-zero start token id", async function () {

    const startTokenId = 510;

    let ERC1155Soul = await ethers.getContractFactory("ERC1155SoulContinuousMockStartTokenId");
